...
public class Customer_BLService_Driver {
	public void drive(Customer_BLService customer_BLService) {
		...
		if (result3 == ResultMessage.ChangePasswordSuccess)
			System.out.println("Change Password Success!");
		customerVO=customer_BLService.getSingle("3202XXXXXXXXXXXXXX");
		if(customerVO==null){
			System.out.println("Not exsit such customer");
		}else{
			System.out.println("get successfullu");
		}
		List<CustomerVO> list = customer_BLService.getAll();
