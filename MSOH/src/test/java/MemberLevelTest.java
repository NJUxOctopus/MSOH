...
public class MemberLevelTest extends TestCase {
    ...
    public void testAddMemberLevel()throws RemoteException{
        ...
        ResultMessage resultMessage2 = memberLevel.addMemberLevel(new MemberLevelVO("pxr",new Timestamp(System.currentTimeMillis()),3,null));
        ResultMessage resultMessage3 = memberLevel.addMemberLevel(new MemberLevelVO("pxr",new Timestamp(System.currentTimeMillis()),-1,a));
    ...
    public void testModifyMemberLevel()throws RemoteException{
        ...
        ResultMessage resultMessage2 = memberLevel.modifyMemberLevel(new MemberLevelVO("pxr",new Timestamp(System.currentTimeMillis()),3,null));
        ResultMessage resultMessage3 = memberLevel.modifyMemberLevel(new MemberLevelVO("pxr",new Timestamp(System.currentTimeMillis()),-1,a));
