...
public class Clerk implements Clerk_BLService {
    ...
    public ResultMessage addClerk(ClerkVO clerkVO) throws RemoteException {
        ...
        ResultMessage resultMessage = hotel.addClerk(clerkVO);
        if (clerkVO.password.matches(DataFormat.Password_Format) &&
            ...
            if (resultMessage == ResultMessage.Clerk_AddClerkSuccess) {
                if (clerk_dataService.addClerk(new ClerkPO(clerkVO.name, clerkVO.phone,
