...
public class Login implements Login_BLService {
    public ResultMessage login(String ID, String password) throws RemoteException {
        ...
        } else if (clerk_dataService_stub.findClerkByID(ID).getPassword() == null ||
                manager_dataService_stub.findManager(ID).getPassword() == null ||
                customer_dataService_stub.findCustomerByID(ID).getPassword() == null ||
                marketer_dataService_stub.findMarketerByID(ID).getPassword() == null) {
